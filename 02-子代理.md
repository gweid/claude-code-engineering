...
Claude 不会未经你批准就创建 team




使用自然语言告诉 Claude 创建团队并描述任务：
...
将 `team-prompt.md` 中的某一种启动模式拷贝到 Claude Code 命令行中，启动 Teams 即可，当前场景下推荐使用：**竞争假设模式**。prompt 如下：
